...
db.books.create([{
    ...
    Thanks to a DNA test, Avery knows she is not a Hawthorne by blood, but clues pile up hinting at a deeper connection to the family than she had ever imagined. As the mystery grows and the plot thickens, Grayson and Jameson, two of the enigmatic and magnetic Hawthorne grandsons, continue to pull Avery in different directions. And there are threats lurking around every corner, as adversaries emerge who will stop at nothing to see Avery out of the picture—by any means necessary. 
    ...
    author: 'Harlen Coben',
    date: '09/15/2011',
    description: 'Mickey Bolitars year can not get much worse. After witnessing his fathers death and sending his mom to rehab, he's forced to live with his estranged uncle Myron and switch high schools. Fortunately, he has met a great girl, Ashley, and it seems like things might finally be improving. But then Ashley vanishes. Mickey follows Ashleys trail into a seedy underworld that reveals that Ashley is not who she claimed to be. And neither was Mickeys father. Soon Mickey learns about a conspiracy so shocking that it leaves him questioning everything about the life he thought he knew.
    First introduced to readers in Harlan Cobens novel Live Wire Mickey Bolitar is as quick-witted and clever as his uncle Myron, and eager to go to any length to save the people he cares about. Follow Mickey Bolitar on his next adventure in Seconds Away!
    Look for all three books in the series!',
    ...
    Langdons worst fears are confirmed on the eve of the Vatican’s holy conclave, when a messenger of the Illuminati announces they have hidden an unstoppable time bomb at the very heart of Vatican City. With the countdown under way, Langdon jets to Rome to join forces with Vittoria Vetra, a beautiful and mysterious Italian scientist, to assist the Vatican in a desperate bid for survival.
    ...
    date: '01/31/2006',
    description: 'Mercy Thompson is a shapeshifter, and while she was raised by werewolves, she can never be one of them, especially after the pack ran her off for having a forbidden love affair. So shes turned her talent for fixing cars into a business and now runs a one-woman mechanic shop in the Tri-Cities area of Washington State.
    But Mercys two worlds are colliding. A half-starved teenage boy arrives at her shop looking for work, only to reveal that he’s a newly changed werewolf—on the run and desperately trying to control his animal instincts. Mercy asks her neighbor Adam Hauptman, the Alpha of the local werewolf pack, for assistance. 
    But Mercys act of kindness has unexpected consequences that leave her no choice but to seek help from those she once considered family—the werewolves who abandoned her...',
